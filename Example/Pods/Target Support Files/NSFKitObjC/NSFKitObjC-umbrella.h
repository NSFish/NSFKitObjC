...
#import "NSFNavigationBarViewModelProtocol.h"
...
FOUNDATION_EXPORT double NSFKitObjCVersionNumber;
FOUNDATION_EXPORT const unsigned char NSFKitObjCVersionString[];
